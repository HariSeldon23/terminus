...
1. Start with "The Major Societies" to understand the fundamental split between the Ascendant and Grounded philosophies.
...
*Next Steps: Visit our [Branch Directory](branches/index.qmd) to start exploring specific timeline branches, or return to [Understanding Timeline Branches](about/timeline-structure.qmd) for a deeper look at how our narrative structure works.*